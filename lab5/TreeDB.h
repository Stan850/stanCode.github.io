 ...
 * Author: oparnica
 *
 * Created on November 19, 2017, 9:40 PM
 */
...
private:
   ...
   bool tree_Insert(TreeNode* treenode, DBentry* entry);
   DBentry* findEntry(TreeNode* treenode, string req_name);
   void PrintAllEntries(TreeNode* treeNode);
   void countRecrActive(TreeNode* treeNode, int & numActive) const;
   void removeAll(TreeNode* treeNode);
   DBentry* findMaxLeftSubRightName(TreeNode* treeNode);
   void removeNode(TreeNode* treeNode, TreeNode* treeTemp, string name);
